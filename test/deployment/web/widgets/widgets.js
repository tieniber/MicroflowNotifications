...
dojo.registerModulePath("MicroflowNotifications", "../../widgets/MicroflowNotifications");
...
/*
    ...
    @file      : MicroflowNotifications.js
    @version   : 1.0
...
require({
    ...
    return declare('MicroflowNotifications.widget.MicroflowNotifications', [ _WidgetBase ], {
		...
		_refresh: function () {
			...
			mx.data.action({
				...
				callback: function (data) {
					...
					i,
					currentButton;
					//n = self._notySingleton;
					
					function makeButtonFunction(bmf) {
						return function(n) {
							var self = this;
					...
					for(i =0; i<buttons.length; i++) {
						...
						buttonmffunction = makeButtonFunction(buttonmf);
